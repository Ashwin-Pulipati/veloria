...
Use the **WASD** or **Arrow Keys** to move your character around the map. Explore the world, avoid obstacles, and interact with different elements. The objective is to navigate through the levels while surviving encounters with monsters.
